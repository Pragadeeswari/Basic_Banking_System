...
<body style="background-image: linear-gradient(315deg, #00b712 0%, #5aff15 74%););background-attachment: fixed;background-repeat: no-repeat;background-size: cover;">
	
<link rel = "stylesheet" type = "text/css" href = "style.css">
	<div class="one" style=" background-color:background-color: #bbf0f3;
...
<span style="color: #67E6EC;">K</span>
	...
	<div class="four"> Now just click the submit button and YOUR  TRANSACTION  IS  SUCCESSFUL:)</div> 
</div>
<div class="five">Designed By C.Pragadeeswari <br> As a part of THE SPARKS FOUNDATION internship.
</div>
</body>
</html>